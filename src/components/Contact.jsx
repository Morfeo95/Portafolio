...
function Contact() {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="relative  overflow-hidden items-center flex flex-col justify-center mt-45" id="contacto">
            <div className="absolute inset-0 z-0 w-full h-full">
                {particles}
            </div>
            <div className="relative z-10 items-center flex flex-col justify-center mb-6">
                <motion.h1 className="text-[#7BAA8F] font-signika text-6xl"
            ...
            />
            <div className="block md:flex md:flex-row-reverse w-full mt-3 justify-between">
                ...
                <div className="flex text-[#7BAA8F] gap-6 mt-3">
                    ...
                    <p className="font-montserrat text-md hover:text-[#4A90E2]">francisco.vera.95@gmail.com</p>
                </div>
            </div>
            </motion.div>
            </div>
